...
filename = os.path.join(os.path.dirname(__file__), "..", "data", "species.txt")
...
filename = os.path.join(os.path.dirname(__file__), "..", "data", "classes.txt")
with open(filename, "rt", encoding="utf8") as file:
...
filename = os.path.join(os.path.dirname(__file__), "..", "data", "powers.txt")
with open(filename, "rt", encoding="utf8") as file:
